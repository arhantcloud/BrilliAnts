    ...
    <div>
      ...
      <div className="mt-5 rounded-2xl bg-slate-50 p-3 ring-1 ring-slate-100">
            ...
            return (
              <div
                ...
                className={`flex min-h-[72px] flex-col items-center justify-center gap-1 rounded-xl border-2 bg-white p-2 transition-colors ${
                  collapsed ? "border-brand-200" : "border-slate-100"
                }`}
              >
                {collapsed ? (
        ...
        <button
          ...
          className="mt-3 w-full rounded-full bg-slate-900 px-4 py-1.5 text-sm font-bold text-white transition active:scale-95"
        >
          {collapsed
            ? "Show all orderings"
      ...
      <div className="mt-6 flex flex-wrap items-center justify-center gap-3 text-2xl font-extrabold text-slate-800">
        <span>
          C({N}, {K}) =
        </span>
        <div className="flex flex-col items-center">
          ...
          <span className="h-1 w-full min-w-[130px] rounded bg-slate-800" />
              ...
              className={`w-12 rounded-lg border-2 px-1 py-1 text-center text-2xl font-extrabold outline-none transition ${
                kCorrect
                  ...
                  : k.trim() !== ""
                    ...
                    : "border-dashed border-slate-300 bg-white text-slate-800 focus:border-brand-400"
              }`}
            />
            <span>!</span>
          </span>
